...
// 🔥 Anti-Tree Shaking Fix 1: Global scope mein ek dummy assignment karein
// Isse Vite build time par ScrollTrigger ko delete nahi karega
...
export default function ImpactSection() {
  ...
  useLayoutEffect(() => {
    // 🔥 Anti-Tree Shaking Fix 2: Hook ke andar bhi register karein
    gsap.registerPlugin(ScrollTrigger);
