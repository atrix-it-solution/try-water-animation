...
//#region node_modules/gsap/dist/ScrollTrigger.js
var require_ScrollTrigger = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		*/
		var gsap$1, _coreInitted$1, _win$1, _doc$1, _docEl$1, _body$1, _root$1, _resizeDelay, _toArray, _clamp$1, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer$1, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context$1, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup$1 = 1, _getTime$1 = Date.now, _time1 = _getTime$1(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp(value, type, self) {
			...
			_scrollers.cache++;
			(force === true || !_refreshing && !_ignoreResize && !_doc$1.fullscreenElement && !_doc$1.webkitFullscreenElement && (!_ignoreMobileResize || _baseScreenWidth !== _win$1.innerWidth || Math.abs(_win$1.innerHeight - _baseScreenHeight) > _win$1.innerHeight * .25)) && _resizeDelay.restart(true);
		...
		var ScrollTrigger$1 = function() {
			...
			_proto.init = function init(vars, animation) {
				...
				if (snap) {
					...
					"scrollBehavior" in _body$1.style && gsap$1.set(isViewport ? [_body$1, _docEl$1] : scroller, { scrollBehavior: "auto" });
			...
			ScrollTrigger.enable = function enable() {
				...
				if (gsap$1) {
					...
					} else if (_doc$1) _doc$1.addEventListener("DOMContentLoaded", function onLoad() {
		...
		exports$1.ScrollTrigger = ScrollTrigger$1;
		exports$1.default = ScrollTrigger$1;
		if (typeof window === "undefined" || window !== exports$1) Object.defineProperty(exports$1, "__esModule", { value: true });
